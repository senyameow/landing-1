                    ...
                    <div className='flex items-center w-full justify-center'>
                        <div className={`lg:w-[535px] lg:h-[377px] w-full h-[400px] relative bg-[#398147] card `}>
                            <div className='w-full h-full flex items-center justify-center'>
                                ...
                                <div className='flex flex-col space-y-[40px]  font-500 px-[20px] lg:px-0 lg:max-w-[455px] mx-auto text-center text-white'>
                                    <div className='lg:text-[30px] text-[60px]'>
                                        Buy $PAPA:
                                    </div>
                                    <div className='lg:text-[24px] text-[36px]'>
                    ...
                    <div className='flex items-center w-full justify-center'>
                        <div className={`lg:w-[535px] lg:h-[377px] w-full h-[400px] relative bg-[#CDF4D3] card `}>
                            <div className='w-full h-full flex items-center justify-center'>
                                ...
                                <div className='flex flex-col space-y-[40px] font-500 px-[20px] lg:px-0 lg:max-w-[455px] mx-auto text-center text-black'>
                                    <div className='lg:text-[30px] text-[60px]'>
                                        HODL:
                                    </div>
                                    <div className='lg:text-[24px] text-[36px]'>
