...
const BackSection_1 = () => {
    return (
        <>
            <img src={bg_1} alt="" className='w-full h-screen object-cover absolute top-0 ' />
            <img src={bg_2} alt="" className='w-full h-screen object-cover absolute top-0 mix-blend-screen text-[#39B54A] bg-[#39B54A]' />
            <img src={bg_2} alt="" className='w-full h-full  absolute top-0 mix-blend-screen' />

            <img src={bg_3} alt="" className='w-full h-full absolute top-[60%] -translate-y-1/2 left-[50%] -translate-x-1/2 ' />
            ...
            <img src={mainPepe} alt="" className='w-[369px] h-[369px] sm:w-[450px] sm:h-[450px] lg:w-[779px] lg:h-[739px] absolute top-[57%] left-[58%] -translate-y-1/2 -translate-x-1/2 lg:top-[45%] lg:left-[50%] ' />
